  ...
  return (
    <section className="bg-ink py-24 text-white md:py-28">
      <div className="container-page text-center">
        <Reveal>
          <h2 className="mx-auto max-w-2xl text-[30px] font-bold leading-tight md:text-[42px]">
            {resumeCta.headline}
          </h2>
          <p className="mx-auto mt-5 max-w-xl text-lg text-slate-300">{resumeCta.supporting}</p>
